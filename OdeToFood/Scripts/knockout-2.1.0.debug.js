...
(function () {
    ...
    ko.bindingContext = function(dataModel, parentBindingContext) {
    ...
    ko.bindingContext.prototype['createChildContext'] = function (dataModel) {
        return new ko.bindingContext(dataModel, this);
    };
...
(function () {
    ...
    ko.renderTemplateForEach = function (template, arrayOrObservableArray, options, targetNode, parentBindingContext) {
        ...
        var executeTemplateForArrayModel = function (arrayValue, index) {
            ...
            arrayModelContext = parentBindingContext['createChildContext'](ko.utils.unwrapObservable(arrayValue));
        ...
        return ko.dependentObservable(function () {
            ...
            ko.utils.setDomNodeChildrenFromArrayMapping(targetNode, filteredArray, executeTemplateForArrayModel, options, activateBindingsCallback);
...
(function () {
    ...
    function fixUpVirtualElements(contiguousNodeArray) {
        ...
        // This is needed so that we can reliably remove or update the nodes corresponding to a given array Model
